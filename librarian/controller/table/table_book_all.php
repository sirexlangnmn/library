...
<?php 
	...
	$book_query = mysqli_query($con,"select * from book where status != 'Archive'")or die(mysql_error());
	while ($row=mysqli_fetch_array($book_query))
	{
		...
		$category_query = mysqli_query($con,"select * from category where category_id = '$category_id'")or die(mysqli_error());
