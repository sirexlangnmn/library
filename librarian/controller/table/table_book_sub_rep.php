...
<tbody>		 
<?php
  	$replacement_query=mysqli_query($con,"select * from book where status = 'Subject for Replacement'")or die(mysql_error());
	while($row=mysqli_fetch_array($replacement_query))
	{
		$book_id = $row['book_id'];  
